...
var alertVariants = classVarianceAuthority.cva("relative flex p-4 font-sm", {
  variants: {
    severity: {
...
var Alert = React__namespace.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React__namespace.createElement(
      ...
      /* @__PURE__ */ React__namespace.createElement("div", { className: cn("relative flex w-full", hasTitle ? "items-start" : "items-center") }, /* @__PURE__ */ React__namespace.createElement(
        "div",
        {
          className: cn(
      ...
      ), /* @__PURE__ */ React__namespace.createElement("div", { className: "flex-1" }, title && /* @__PURE__ */ React__namespace.createElement("div", { className: "font-medium" }, title), /* @__PURE__ */ React__namespace.createElement("div", { className: "text-alert" }, children)))
    );
  }
);
